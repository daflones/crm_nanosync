-- Fix notificacoes prioridade constraint and trigger function
-- This resolves the constraint violation error when creating agendamentos
...
BEGIN
    INSERT INTO notificacoes (
        ...
        NEW.id,
        'agendamento',
        'media', -- Changed from 'normal' to 'media' to match constraint
        json_build_object(
            'titulo', NEW.titulo,
